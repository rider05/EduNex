...
echo ===================================================================
echo   EduNex Automated APK Builder, Version Exporter and Git Pipeline
echo ===================================================================
echo.
...
if %EXIT_CODE% equ 0 (
    echo.
    echo ===================================================================
    echo [OK] Release build, packaging and GitHub synchronization complete!
    echo ===================================================================
    echo.
    if "%~1"=="" pause
    exit /b 0
    ...
    echo.
    echo [!] Build pipeline exited with error code %EXIT_CODE%.
    echo.
    if "%~1"=="" pause
    exit /b %EXIT_CODE%
)
